...
<option value="Villa María del triunfo">Villa María del triunfo</option>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><br />            <input type="submit" name="registrar" id="registrar" value="Regístra tu local" /><p><a href="servicios-adicionales.html">Registrar servicios adicionales</a></p></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
