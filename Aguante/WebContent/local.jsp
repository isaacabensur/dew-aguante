...
<div id="cuerpo">
    <h3>Registro de local</h3><form name="registrarLocal" action="LocalServlet" method="post" >
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        ...
        <tr>
          <td align="right" valign="middle"><label for="direccion">Direcci�n</label></td>
          <td>
...
<option value="Villa María del triunfo">Villa María del triunfo</option>
        ...
        <tr>
          <td align="right" valign="middle"><label for="dicGoogle">Direcci�n de Google</label></td>
          <td>
          <input type="text" name="dicGoogle" id="dicGoogle" /></td>
        </tr>
        <tr>
          <td align="right" valign="middle"><label for="telefonoFijo">Tel�fono fijo</label></td>
          <td><input type="text" name="telefonoFijo" id="telefonoFijo" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><br />            <input type="submit" name="registrar" id="registrar" value="Reg�stra tu local" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
