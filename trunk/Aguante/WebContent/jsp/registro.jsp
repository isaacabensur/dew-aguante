...
<div id="cuerpo">
    ...
    <form action="" method="get">
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="29%" align="right" valign="middle"><label for="tipoPer">Tipo  de persona</label></td>
          <td width="71%">
        ...
        <tr>
          <td align="right" valign="middle"><label for="nombres">Nombres</label></td>
          <td>
        ...
        <tr>
          ...
          <td>
          <input type="text" name="numDoc" id="numDoc" /></td>
        </tr>
        <tr>
...
<option value="1905" >1905</option>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><br />            <input type="submit" name="registrar" id="registrar" value="Regístrate" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
