...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td width="71%">Leyendas Peruanas <% out.println(request.getParameter("id"));  %></td>
      </tr>
      <tr>
        <td width="29%" align="right" valign="middle"><label for="nombre">Nombre de cancha</label></td>
        <td width="71%">Te贸filo &quot;Nene&quot; Cubillas</td>
      </tr>
      <tr>
        <td align="right" valign="middle"><label for="caracteristicas">Caracter韘ticas</label></td>
        <td>Pasto sint茅tico, futbol 6</td>
      </tr>
      <tr>
        <td align="right" valign="middle"><label for="diasAtencion">Dias de atenci髇</label></td>
        <td>Lunes a Viernes</td>
      </tr>
      <tr>
        <td align="right" valign="middle"><label for="horasAtencion">Horas de atenci贸n</label></td>
        <td>10:00 a 23:00</td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" valign="middle"> <label for="promo">Promoci贸n especial</label></td>
        <td>Los mi茅rcoles de 5 p.m. a 7 p.m. juega 02 horas paga solo una</td>
      </tr>
      <tr>
    ...
    <form action="" method="get">
      <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="29%" align="right" valign="middle"><label for="descLoc">Calificaci贸n</label></td>
...
<label>5</label></td>
  ...
  </div></div><div id="piecera">Futbol Camp tiene todos los derechos 庐 reservados  </div>
</body>
</html>